...
const Accountlist = () => {
  ...
  useEffect(() => {
    ...
    // Fetch data from API
    axios.get("https://13.236.44.51:3001/api/users", axiosConfig)
      .then((res) => {
  ...
  const updateBan = (id) => {
    ...
    // Fetch data from API
    axios.patch(`https://13.236.44.51:3001/api/users/${id}/banned`, null, axiosConfig)
      .then((res) => {
  ...
  const updateUnban = (id) => {
    ...
    // Fetch data from API
    axios.patch(`https://13.236.44.51:3001/api/users/${id}/unbanned`, null, axiosConfig)
      .then((res) => {
        // Xử lý dữ liệu trả về nếu cần
      })
      .catch((error) => {
